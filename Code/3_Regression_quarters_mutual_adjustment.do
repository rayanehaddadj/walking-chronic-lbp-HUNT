...
foreach var in volume_qrt intensity_qrt {
	...
	// Define Additional Adjustment Variable
	if ("`var'" == "volume_qrt") {
		local adj walk_mets
	}
	...
	collect: poisson lbp_t1 i.`var' age i.sex i.education i.income i.work_status i.smoking i.depression `adj', vce(robust) irr
	...
	// Format Cells Headers and Values
...
// Save Word Document
putdocx save "### Your file path ###\Paper1_perso\Figures\Regression_quarters_mutual_adjustment.docx", replace
